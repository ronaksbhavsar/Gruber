...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__chats__ = __webpack_require__(461);
...
ChatsPageModule = __decorate([
    Object(__WEBPACK_IMPORTED_MODULE_2__angular_core__["NgModule"])({
        ...
        imports: [
            __WEBPACK_IMPORTED_MODULE_4_ionic_angular__["i" /* IonicPageModule */].forChild(__WEBPACK_IMPORTED_MODULE_1__chats__["a" /* ChatsPage */]),
...
var ChatsPage = (function () {
    function ChatsPage(navCtrl, loadingCtrl, translate, sync, dataService) {
        ...
        this.chatsData = [];
        this.status = false;
        this.userFilter = { dispatcherName: '', lastMessage: '' };
    }
    ChatsPage.prototype.ionViewDidLoad = function () {
        this.getChatsData();
    };
    ChatsPage.prototype.getChatsData = function () {
        var _this = this;
        var loadingLabelString = "";
        this.translate.get('LOADING_LABEL').subscribe(function (value) {
        ...
        this.dataService.getUser().then(function (res) {
            _this.dataService.getChatsByDp_id(res.id).then(function (response) {
                _this.chatsData = response;
                loader.dismiss();
            });
        });
    };
    ChatsPage.prototype.syncData = function () {
    ...
    ChatsPage.prototype.viewContacts = function (pageName) {
        this.navCtrl.push(pageName);
    };
    ChatsPage.prototype.goToOtherPage = function (pageName) {
        //push another page onto the history stack
        //causing the nav controller to animate the new page in
        this.navCtrl.push(pageName);
    };
    ChatsPage.prototype.generateUserIcon = function (nameCharacter) {
        var colorArr = [
            "#51b8a3",
            "#5abd53",
            "#1866fa",
