webpackJsonp([1],Array(316).concat([
/* 316 */
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__app_shared_module__ = __webpack_require__(448);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__chat_contacts__ = __webpack_require__(460);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5_ng2_filter_pipe__ = __webpack_require__(456);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5_ng2_filter_pipe___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_5_ng2_filter_pipe__);
...
ChatContactsPageModule = __decorate([
    Object(__WEBPACK_IMPORTED_MODULE_2__angular_core__["NgModule"])({
        declarations: [
            __WEBPACK_IMPORTED_MODULE_1__chat_contacts__["a" /* ChatContactsPage */],
        ],
        imports: [
            __WEBPACK_IMPORTED_MODULE_4_ionic_angular__["i" /* IonicPageModule */].forChild(__WEBPACK_IMPORTED_MODULE_1__chat_contacts__["a" /* ChatContactsPage */]),
            __WEBPACK_IMPORTED_MODULE_3__ngx_translate_core__["b" /* TranslateModule */].forChild(),
            __WEBPACK_IMPORTED_MODULE_0__app_shared_module__["a" /* SharedModule */],
            __WEBPACK_IMPORTED_MODULE_5_ng2_filter_pipe__["Ng2FilterPipeModule"]
        ],
        exports: [
            __WEBPACK_IMPORTED_MODULE_1__chat_contacts__["a" /* ChatContactsPage */]
        ]
...
;(function (global, factory) {
    true ? factory(__webpack_require__(327)) :
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__app_imports__ = __webpack_require__(449);
...
SharedModule = __decorate([
    Object(__WEBPACK_IMPORTED_MODULE_1__angular_core__["NgModule"])({
        declarations: [
            __WEBPACK_IMPORTED_MODULE_0__app_imports__["a" /* PIPES */]
        ],
        imports: [
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__pipes_moment_pipe__ = __webpack_require__(450);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__pipes_temperature_pipe__ = __webpack_require__(451);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__pipes_orderby_pipe__ = __webpack_require__(452);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__pipes_shorten_pipe__ = __webpack_require__(453);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__pipes_capitalize_pipe__ = __webpack_require__(454);
// Pipes
...
var PIPES = [
    __WEBPACK_IMPORTED_MODULE_1__pipes_temperature_pipe__["a" /* TemperaturePipe */],
    __WEBPACK_IMPORTED_MODULE_0__pipes_moment_pipe__["a" /* MomentPipe */],
    __WEBPACK_IMPORTED_MODULE_2__pipes_orderby_pipe__["a" /* OrderByPipe */],
    __WEBPACK_IMPORTED_MODULE_4__pipes_capitalize_pipe__["a" /* CapitalizePipe */],
    __WEBPACK_IMPORTED_MODULE_3__pipes_shorten_pipe__["a" /* ShortenStringPipe */]
];
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_moment__ = __webpack_require__(327);
 ...
 */
var core_1 = __webpack_require__(0);
var ng2_filter_pipe_1 = __webpack_require__(455);
...
var ChatContactsPage = (function () {
    function ChatContactsPage(navCtrl, translate, sync, loadingCtrl, dataService) {
        var _this = this;
        ...
        // userId: string = "";
        this.userChatList = [];
        this.userFilter = { dp_name: '', dp_phone: '' };
        this.MobMessages = [];
    ...
    ChatContactsPage.prototype.ionViewDidLoad = function () {
        this.getChatContacts();
    };
    ChatContactsPage.prototype.getChatContacts = function () {
        var _this = this;
        var loader = this.loadingCtrl.create({
            content: this.tranlageMessage['LOADING_LABEL'],
        });
        this.dataService.getMob_dispatchers().then(function (response) {
            _this.userChatList = response;
            loader.dismiss();
        });
    };
    ChatContactsPage.prototype.viewMessages = function (chat) {
        var _this = this;
        var loader = this.loadingCtrl.create({
            content: this.tranlageMessage['LOADING_LABEL'],
        });
        loader.present();
        this.dataService.getMob_messagesByDp_id(this.user.id, chat.id).then(function (response) {
            if (response.length == 0) {
                ...
                _this.sync.insertTableRow('mob_messages', _this.MobMessageObj).then(function (msg) {
                    ...
                    loader.dismiss();
                    _this.navCtrl.push('MessagesPage', { DpName: chat.dp_name, MessageId: msg.id, DpPhone: msg.m_objectKey });
                });
            }
            else {
                loader.dismiss();
                // already availbale in messages. so no need to add it again.
                _this.navCtrl.push('MessagesPage', { DpName: chat.dp_name, MessageId: response[0].id, DpPhone: response[0].m_objectKey });
            }
        });
    };
    ChatContactsPage.prototype.syncData = function () {
    ...
    ChatContactsPage.prototype.goToOtherPage = function (pageName) {
        //push another page onto the history stack
        //causing the nav controller to animate the new page in
        this.navCtrl.push(pageName);
    };
    ChatContactsPage.prototype.generateUserIcon = function (nameCharacter) {
        var colorArr = [
            "#51b8a3",
            "#5abd53",
            "#1866fa",
        ...
        var charASCCI = nameCharacter.charCodeAt(0);
        var mod = charASCCI % 6;
        //let k = colorArr[Math.floor(Math.random() * colorArr.length)];
        var profilePpictureStyle = {
...
ChatContactsPage = __decorate([
    Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"])({
        selector: 'page-chat-contacts',template:/*ion-inline-start:"D:\Gruber\MobileApp\Gruber\src\pages\chat-contacts\chat-contacts.html"*/'<ion-header>\n\n    <ion-navbar>\n\n        <ion-title>\n\n            {{\'CHAT_CONTACTS_TITLE\' | translate}}\n\n        </ion-title>\n\n      \n\n        <ion-buttons end>\n\n            <button ion-button icon-only item-end >\n\n                <ion-icon name="ios-notifications-outline" (click)="goToOtherPage(\'NotificationsListPage\')"></ion-icon>\n\n            </button>\n\n            <button ion-button icon-only item-end (click)="syncData()">\n\n                <ion-icon name="ios-refresh-outline"></ion-icon>\n\n                {{\'SYNC\' | translate}}\n\n            </button>\n\n        </ion-buttons>\n\n    </ion-navbar>\n\n    <ion-toolbar>\n\n        <ion-searchbar class="searchbox" [(ngModel)]="userFilter.dp_name"></ion-searchbar>\n\n    </ion-toolbar>\n\n</ion-header>\n\n<ion-content class="chats">\n\n    \n\n    <ion-list>\n\n        <!--<ion-list-header>Contacts</ion-list-header>-->\n\n        <ion-item *ngFor="let chat of userChatList | filterBy: userFilter" (click)="viewMessages(chat)">\n\n            <ion-avatar item-start class="profile-picture" [ngStyle]="generateUserIcon(chat.dp_name.charAt(0))">\n\n                <span>{{chat.dp_name.charAt(0)}}</span>\n\n            </ion-avatar>\n\n            <h2>{{chat.dp_name}}</h2>\n\n            <p>{{chat.dp_phone}}</p>\n\n        </ion-item>\n\n    </ion-list>\n\n   \n\n</ion-content>\n\n'/*ion-inline-end:"D:\Gruber\MobileApp\Gruber\src\pages\chat-contacts\chat-contacts.html"*/,
    }),
