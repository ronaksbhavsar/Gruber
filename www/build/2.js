...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__messages__ = __webpack_require__(462);
...
MessagesPageModule = __decorate([
    Object(__WEBPACK_IMPORTED_MODULE_2__angular_core__["NgModule"])({
        ...
        imports: [
            __WEBPACK_IMPORTED_MODULE_4_ionic_angular__["i" /* IonicPageModule */].forChild(__WEBPACK_IMPORTED_MODULE_1__messages__["a" /* MessagesPage */]),
...
var MessagesPage = (function () {
    function MessagesPage(navCtrl, formBuilder, navParams, loadingCtrl, translate, sync, dataService) {
        var _this = this;
    ...
    MessagesPage.prototype.getMessagesTexts = function () {
        var _this = this;
        this.dataService.getMob_messagesTextsByMessageId(this.MessageId)
            .then(function (response) {
            _this.messages = response;
            var messageCount = response.length - 1;
            if (messageCount > 0) {
                _this.LastMessageDatetime = response[messageCount].ms_dtcreation;
            }
            _this.scrollToBottom();
            _this.getLatestMessagesTexts();
            setTimeout(function () {
                for (var v in _this.messages) {
                    if (!_this.messages[v].Mob_messagesTextsReadId && _this.user.id != _this.messages[v].ms_sender) {
                        var readMessage = {
                            ms_messageId: _this.MessageId.toString(),
                            ms_messageTextId: _this.messages[v].id,
                            ms_user: _this.user.id.toString(),
                            ms_dtRead: new Date(),
                            deleted: false
                        };
                        _this.sync.insertTableRow('Mob_messagesTextsRead', readMessage).then(function (data) {
                            _this.messages[v].Mob_messagesTextsReadId = data.id;
                            // this.getMessagesTexts();
                        });
                    }
                }
    ...
    MessagesPage.prototype.getLatestMessagesTexts = function () {
        var _this = this;
        this.timerMessages = setInterval(function () {
            _this.sync.syncMessageTextsRelatedLocalTables().then(function () {
                _this.dataService.getMob_messagesTextsByMessageIdAndDatetime(_this.MessageId, _this.LastMessageDatetime)
                    .then(function (latestMessages) {
                    //let messageCount = latestMessages.length - 1;
                    //alert(JSON.stringify(latestMessages));
                    latestMessages.forEach(function (messageData) {
                        _this.messages.push(messageData);
                        _this.LastMessageDatetime = messageData.ms_dtcreation;
                    });
    ...
    MessagesPage.prototype.send = function (message) {
        ...
        if (message && message !== '') {
            ...
            this.sync.insertTableRow('Mob_messagesTexts', messageData_1)
                .then(function (result) {
                //this.msMessageTextId = result.id;
                _this.messages.push(messageData_1);
    ...
    MessagesPage.prototype.goToOtherPage = function (pageName) {
        //push another page onto the history stack
        //causing the nav controller to animate the new page in
        this.navCtrl.push(pageName);
    };
    MessagesPage.prototype.syncData = function () {
        // Our translated text strings
        var syncingLabelString = "";
        this.translate.get('SYNCING_LABEL').subscribe(function (value) {
    ...
    MessagesPage.prototype.onProfilePicError = function () {
    };
    ;
    return MessagesPage;
}());
__decorate([
    Object(__WEBPACK_IMPORTED_MODULE_1__angular_core__["ViewChild"])(__WEBPACK_IMPORTED_MODULE_3_ionic_angular__["d" /* Content */]),
